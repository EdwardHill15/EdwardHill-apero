...
long %>% 
    ...
    labs(fill = "", x = "", y = "Stress Experience",
         ...
         title = "Figure 1: consciousness and stress",
         subtitle = "The relation between unwholesome consciousness and stress experience.")
```
...
long %>% 
    ...
    labs(fill = "", x = "", y = "Stress Experience",
         caption = "Data from {NVM database} The Vibrational Mind.",
         title = "Figure 2: consciousness and stress by gender",
  ...
  list(
    ...
    "as_gt-lst:addl_cmds"= list(
      ...
      user_added1 = rlang::expr(gt::tab_header(
        title = "Table 1: Depression predicted by Unwholesome Consciousness", 
